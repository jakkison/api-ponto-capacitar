...
import com.capacitar.pontoapi.dtos.CadastroPFDto;
...
public class CadastroPFController {
	...
	public ResponseEntity<Response<CadastroPFDto>> cadastrar(@Valid @RequestBody CadastroPFDto cadastroPFDto,
		...
		Optional<Empresa> empresa = this.empService.buscarPorCNPJ(cadastroPFDto.getCnpj());
	...
	private void validarDadosExistentes(CadastroPFDto cadastroPFDto, BindingResult result) {
		...
		this.funcService.buscarPorCPF(cadastroPFDto.getCpf())
			.ifPresent(func -> result.addError(new ObjectError("funcionario", "CPF já existente.")));

		this.funcService.buscarPorEmail(cadastroPFDto.getEmail())
